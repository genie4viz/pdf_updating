var classManagePDF = function () {
  ...
  main.scale = 1;
  main.default_width = 0;
  main.default_height = 0;
  main.page_num = 1;
  main.curr_page = null;
  ...
  main.viewPDF = function (scale, page_no, callback) {
    ...
    PDFJS.getDocument(main.curr_pdfurl)
      ...
      .then(function (page) {
        ...
        $('.page').append($('#popup_area')); //ksh
        $('.page').append($('#context_menu'));
        ...
        // set scale 1 size;
        main.default_width = main.scale * $('.page').width();
        main.default_height = main.scale * $('.page').height();
      });
  };
